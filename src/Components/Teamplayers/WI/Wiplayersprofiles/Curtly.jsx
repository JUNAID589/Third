...
import ambrose from "../../../../assets/curtly.png";  // Update the image import if needed
      ...
      <div className="container">
        ...
        <div className="row mt-5">
          <div className="d-flex justify-content-center">
            <img className="profilepic" src={ambrose} alt="ambrose" />
          </div>
        </div>
